//------------------------------------------------------------------------------------//
//GoogleAPIを使って指定したGoogleスプレッドシートを読み取るファイル
//読み取り対象は
//「https://docs.google.com/spreadsheets/d/18r426QEVLd02xq_K1itztam-89rMDgl53CuBpeyYwHM/edit#gid=0」
//内の「シート3」の「B2」になります
//------------------------------------------------------------------------------------//
...
const sheet = '1g4wqAemOfcmYj0cop7LkFnp-_kYx2Eum1FWAXfmr0O0';
